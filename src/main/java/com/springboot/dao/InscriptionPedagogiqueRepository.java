...
public interface InscriptionPedagogiqueRepository extends JpaRepository<Etudiant,String> {
    ...
    @Query(value="select i from InscriptionPedagogique i where i.cne =:cne order by i.date_inscription_valide DESC")
    public InscriptionPedagogique getByCne(@Param("cne")String cne);
}
